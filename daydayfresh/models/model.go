...
func init() {
	...
	//注册表
	orm.RegisterModel(new(User), new(Receiver), new(OrderGoods), new(OrderInfo), new(IndexPromotionBanner), new(IndexTypeGoodsBanner), new(IndexGoodsBanner), new(GoodsImage), new(GoodsSKU), new(GoodsType))
	//跑起来
